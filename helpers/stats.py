...
def covariance(returns: pd.DataFrame, periods_per_year: int = 252) -> pd.DataFrame:
    """Annualized sample covariance."""
    return returns.cov() * periods_per_year


def covariance_shrunk(returns: pd.DataFrame, periods_per_year: int = 252) -> pd.DataFrame:
    """Annualized Ledoit-Wolf covariance."""
